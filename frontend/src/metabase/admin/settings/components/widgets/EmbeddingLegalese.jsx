...
const EmbeddingLegalese = ({ onChange }) => (
  <div className="bordered rounded text-measure p4">
    ...
    <p className="text-medium" style={{ lineHeight: 1.48 }}>
      {t`In plain English, when you embed charts or dashboards from Kenga Analytics in your own application, that application isn't subject to the Affero General Public License that covers the rest of Kenga Analytics, provided you keep the Kenga Analytics logo and the "Powered by Kenga Analytics" visible on those embeds. You should, however, read the license text linked above as that is the actual license that you will be agreeing to by enabling this feature.`}
    </p>
