...
class PremiumTokenInput extends Component {
  ...
  render() {
    ...
    if (errorMessage) {
      ...
      message = t`Enter the token you bought from the Kenga Analytics Store`;
    }
...
const PremiumExplanation = ({ showEnterScreen }) => (
  <div>
    ...
    <p className="mt1">{t`Premium embedding lets you disable "Powered by Kenga Analytics" on your embedded dashboards and questions.`}</p>
