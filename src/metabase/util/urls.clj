(ns metabase.util.urls
  "Utility functions for generating the frontend URLs that correspond various user-facing Kenga Analytics *objects*, like Cards or Dashboards.
   ...
   Functions for generating URLs not related to Kenga Analytics *objects* generally do not belong here, unless they are used in many places in the
