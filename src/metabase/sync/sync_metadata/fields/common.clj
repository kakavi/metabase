...
(def TableMetadataFieldWithID
  "Schema for `TableMetadataField` with an included ID of the corresponding Kenga Analytics Field object.
...
(s/defn matching-field-metadata :- (s/maybe TableMetadataFieldWithOptionalID)
  ...
  corresponding Kenga Analytics Field for field metadata from the DB, or vice versa."
